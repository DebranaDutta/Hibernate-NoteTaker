<nav class="navbar navbar-expand-lg navbar-light purple">
	<a class="navbar-brand"><b>NoteTaker</b></a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="showNotesController">Show Notes</a></li>
		</ul>
		<form class="form-inline my-2 my-lg-0">
			<input class="form-control mr-sm-2 search1" type="search" placeholder="Search" aria-label="Search">
			<button class="btn btn-outline-dark my-2 my-sm-0 button1" type="submit">Search</button>
		</form>
	</div>
</nav>